...
const links = [
  ...
  },
  {
    ...
    items: [
      {
        name: '所有面试题',
        url: 'https://www.yuque.com/silence1224/zvw0fi/qskx1m?singleDoc#94c7f2e1',
      },
      { name: '前端面试题汇总', url: 'https://www.yuque.com/cuggz/interview' },
      {
        name: '2024年前端最新场景题面试.pdf',
        url: 'public/doc/2024年前端最新场景题面试.pdf',
      },
    ],
  },
]
